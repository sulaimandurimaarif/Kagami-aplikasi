...
const DEFAULT_TITLES = [
  ...
  { id: "m-2", title: "One Piece", type: "Manga", rating: 4.8, chapters: 1102, coverURL: "https://res.cloudinary.com/afzv0bq5/image/upload/v1784384442/0u2aefrzacmc1_dzsccf.jpg?v=4", description: "Monkey D. Luffy refuses to let anyone or anything stand in the way of his quest to become the king of all pirates. With a course charted for the treacherous waters of the Grand Line and beyond, this is one captain who'll never give up until he's claimed the greatest treasure on Earth: the Legendary One Piece!", dateAdded: "2026-05-15", views: 98000, status: "Ongoing" },

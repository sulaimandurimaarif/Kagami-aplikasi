...
const DEFAULT_TITLES = [
  ...
  { id: "m-2", title: "One Piece", type: "Manga", rating: 4.8, chapters: 1102, coverURL: "<a href="https://freeimage.host/i/CjkPoKv"><img src="https://iili.io/CjkPoKv.md.webp" alt="CjkPoKv.md.webp" border="0"></a>", description: "Monkey D. Luffy refuses to let anyone or anything stand in the way of his quest to become the king of all pirates. With a course charted for the treacherous waters of the Grand Line and beyond, this is one captain who'll never give up until he's claimed the greatest treasure on Earth: the Legendary One Piece!", dateAdded: "2026-05-15", views: 98000, status: "Ongoing" },

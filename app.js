...
const DEFAULT_TITLES = [
  { id: "m-1", title: "Solo Leveling", type: "Manhwa", rating: 4.9, chapters: 179, color: "linear-gradient(135deg, #1e3a8a, #3b82f6)", description: "In a world where hunters must battle deadly monsters to protect mankind, Sung Jinwoo, the weakest hunter of all mankind, finds himself in a struggle for survival in a double dungeon. After surviving a near-death trial, he awakens with a unique system that allows him to level up without limits.", dateAdded: "2026-01-10", views: 24500, status: "Completed", author: "Chugong", genre: ["Action", "Fantasy", "Adventure"] },
  { id: "m-2", title: "One Piece", type: "Manga", rating: 4.8, chapters: 1102, coverUrl: "https://raw.githubusercontent.com/sulaimandurimaarif/Manga-Cover/main/One%20Piece.png?v=2", description: "Monkey D. Luffy refuses to let anyone or anything stand in the way of his quest to become the king of all pirates. With a course charted for the treacherous waters of the Grand Line and beyond, this is one captain who'll never give up until he's claimed the greatest treasure on Earth: the Legendary One Piece!", dateAdded: "2026-05-15", views: 98000, status: "Ongoing", author: "Eiichiro Oda", genre: ["Action", "Adventure", "Comedy", "Fantasy"] },
  { id: "m-3", title: "Noblesse", type: "Manhwa", rating: 4.7, chapters: 544, coverUrl: "https://raw.githubusercontent.com/sulaimandurimaarif/Manga-Cover/main/One%20Piece.png?v=2", description: "Rai awakens from his 820-year sleep. He starts his new life as a student in a high school founded by his loyal servant, Frankenstein. But his peaceful days are soon interrupted by mysterious attackers known as the Union.", dateAdded: "2025-11-20", views: 18400, status: "Completed", author: "Son Jeho", genre: ["Action", "Supernatural", "School"] },
  { id: "m-4", title: "Tower of God", type: "Manhwa", rating: 4.6, chapters: 590, color: "linear-gradient(135deg, #064e3b, #10b981)", description: "What do you desire? Money and wealth? Honor and pride? Authority and power? Revenge? Or something that transcends all of them? Whatever you desire—it is here. Tower of God. Reach the top, and everything will be yours.", dateAdded: "2026-07-01", views: 42000, status: "Ongoing", author: "SIU", genre: ["Action", "Fantasy", "Mystery"] },
  { id: "m-5", title: "Jujutsu Kaisen", type: "Manga", rating: 4.8, chapters: 271, coverUrl: "https://github.com/sulaimandurimaarif/Manga-Cover/blob/main/cover-jujutsu-kaisen.jpg?raw=true", description: "In a world where cursed spirits feed on unsuspecting humans, fragments of the legendary and feared demon Ryomen Sukuna have been lost and scattered. Should any demon consume Sukuna's body parts, the power they gain could destroy the world as we know it. Fortunately, there exists a mysterious school of Jujutsu Sorcerers who exist to protect the living from the undead!", dateAdded: "2026-06-25", views: 67000, status: "Completed", author: "Gege Akutami", genre: ["Action", "Supernatural", "Horror"] },
  ...
  { id: "m-7", title: "My Hero Academia", type: "Manga", rating: 4.4, chapters: 398, coverUrl: "https://github.com/sulaimandurimaarif/Manga-Cover/blob/main/cover%20my%20hero%20academia.jpg?raw=true", description: "Middle school student Izuku Midoriya wants to be a hero more than anything, but he hasn't got an ounce of power in him. With no chance of ever getting into the prestigious U.A. High School for budding heroes, his life is looking more and more like a dead end. Then an encounter with All Might, the greatest hero of them all, gives him a chance to change his destiny...", dateAdded: "2026-04-18", views: 35000, status: "Completed", author: "Kohei Horikoshi", genre: ["Action", "School", "Superhero"] },
  { id: "m-8", title: "The Breaker", type: "Manhwa", rating: 4.7, chapters: 200, color: "linear-gradient(135deg, #0f172a, #334155)", description: "The new English teacher, Chun-Woo, is not your ordinary teacher. Shioon, a victim of constant bullying, accidentally witnesses Chun-Woo's martial arts power, and begs Chun-Woo to make him his disciple.", dateAdded: "2025-09-05", views: 12000, status: "Completed", author: "Jeon Geuk-jin", genre: ["Action", "Martial Arts", "School"] },
  { id: "m-9", title: "Martial Peak", type: "Manhua", rating: 4.3, chapters: 2400, color: "linear-gradient(135deg, #14532d, #22c55e)", description: "The journey to the martial peak is a lonely, solitary and long struggle. In the face of adversity, you must survive and remain unyielding. Only then can you break through and continue on your journey to become the strongest.", dateAdded: "2026-07-15", views: 89000, status: "Ongoing", author: "Momo", genre: ["Action", "Martial Arts", "Adventure"] },
  { id: "m-10", title: "Demon Slayer", type: "Manga", rating: 4.9, chapters: 205, color: "linear-gradient(135deg, #7f1d1d, #ef4444)", description: "It is the Taisho Period in Japan. Tanjiro, a kindhearted boy who sells charcoal for a living, finds his family slaughtered by a demon. To make matters worse, his younger sister Nezuko, the sole survivor, has been transformed into a demon herself. Though devastated by this grim reality, Tanjiro resolves to become a demon slayer to turn his sister back into a human.", dateAdded: "2026-03-30", views: 75000, status: "Completed", author: "Koyoharu Gotouge", genre: ["Action", "Supernatural", "Historical"] },
  { id: "m-11", title: "Chainsaw Man", type: "Manga", rating: 4.7, chapters: 150, color: "linear-gradient(135deg, #451a03, #f97316)", description: "Denji is a teenage boy living with a Chainsaw Devil named Pochita. Due to the debt his father left behind, he has been living a rock-bottom life while repaying his debt by harvesting devil corpses with Pochita. One day, Denji is betrayed and killed. As his consciousness fades, he makes a contract with Pochita and gets revived as Chainsaw Man.", dateAdded: "2026-05-02", views: 51000, status: "Ongoing", author: "Tatsuki Fujimoto", genre: ["Action", "Horror", "Dark Fantasy"] },
...
function renderGenreFilterChips() {
  ...
  container.innerHTML = genres.map(g => `
    <button type="button" class="genre-filter-chip ${state.searchFilters.genres.includes(g) ? 'active' : ''}" data-genre="${g}">${g}</button>
  `).join('');
...
function openDetailsModal(id) {
  ...
  if (genreList) {
    ...
    genreList.innerHTML = genres.map(g => `<button type="button" class="genre-chip" data-genre="${g}">${g}</button>`).join('');
...
function renderMangaPages() {
  ...
  const images = (readerActiveItem.chapterImages && readerActiveItem.chapterImages.length > 0)
    ? readerActiveItem.chapterImages
    : [readerActiveItem.coverUrl || ''];
